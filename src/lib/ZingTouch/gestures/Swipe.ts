...
class Swipe extends Gesture {
  ...
  constructor(options: any) {
     ...
     * @type {String}
     */
    // @ts-expect-error ts-migrate(2339) FIXME: Property 'type' does not exist on type 'Swipe'.
    this.type = 'swipe';
     ...
     * @type {Number}
     */
    // @ts-expect-error ts-migrate(2339) FIXME: Property 'maxRestTime' does not exist on type 'Swi... Remove this comment to see the full error message
     ...
     * @type {number}
     */
    // @ts-expect-error ts-migrate(2339) FIXME: Property 'escapeVelocity' does not exist on type '... Remove this comment to see the full error message
     ...
     * @type {number}
     */
    // @ts-expect-error ts-migrate(2339) FIXME: Property 'timeDistortion' does not exist on type '... Remove this comment to see the full error message
     ...
     * @type {number}
     */
    // @ts-expect-error ts-migrate(2339) FIXME: Property 'maxProgressStack' does not exist on type... Remove this comment to see the full error message
    ...
    if (options && options.onMove && typeof options.onMove === 'function') {
      // @ts-expect-error ts-migrate(2551) FIXME: Property 'onMove' does not exist on type 'Swipe'. ... Remove this comment to see the full error message
    ...
    if (options && options.onEnd && typeof options.onEnd === 'function') {
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'onEnd' does not exist on type 'Swipe'.
   ...
   */
    ...
    if (this.numInputs === inputs.length) {
      ...
      for (var i = 0; i < output.data.length; i++) {
        // @ts-expect-error ts-migrate(2454) FIXME: Variable 'velocity' is used before being assigned.
